...
public class DocumentServiceImpl implements DocumentService {
    ...
    @Override
    public List<Document> getDocumentsByClientRegistrationNumber(Long registrationNumber) {
        return documentRepository.findByClientRegistrationNumber(registrationNumber);
    }
}
