...
public interface ClientRepository extends JpaRepository<Client, Long> {
    ...
    @Query("SELECT new com.techlabs.dto.BeneficiaryDTO(bp.beneficiaryId, bp.beneficiaryName, bp.beneficiaryAccountNumber, bp.beneficiaryIfsc, bp.beneficiaryAmount, c.registrationNumber) " +
           "FROM Beneficiary bp JOIN Client c ON bp.client.id = c.id " +
